...
\lhead{\emph{Lista delle Figure}} % Set the left side page header to "List of Figures"
...
\lhead{\emph{Biblografia}} % Change the page header to say "Bibliography"
