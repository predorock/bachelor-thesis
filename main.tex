...
Il re-utilizzo del codice tra le diverse piattaforme non è possibile, quindi dobbiamo scrive
 -- o re scriviamo la applicazione --
 -- oppure usiamo delle tecnologie che ci consentono di compilare un unico codice sorgente e ottenere la nostra applicazione per ogni piattaforma che abbiamo scelto.   

Questa tesi si propone l'obiettivo di analizzare le tecnologie sul mercato attuale per ricorrere ad un modello di sviluppo di applicazioni multi-piattaforma per dispositivi mobili , in particolare con l'utilizzo di tecnologie web.
